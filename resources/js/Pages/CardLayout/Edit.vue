            ...
            <form @submit.prevent="update">
                ...
                <div class="card mb-4 mb-xl-10">
                    <div class="card-body">
                        ...
                        <div v-if="!form.json_data.link_to_content">
                            <Divider />
                ...
                <ContentArea :form="form" :use-sections="false" :use-containers="false" :layout-mode="true" :add-section="props.layout.content && props.layout.content.length > 0 ? false : true"/>
...
const form = useForm({
    ...
    json_data:{
        link_to_content:props.layout.json_data && props.layout.json_data.link_to_content ? props.layout.json_data.link_to_content : false,
        link_to_depending_content:props.layout.json_data && props.layout.json_data.link_to_depending_content ? props.layout.json_data.link_to_depending_content : false,
        link_to_attribute:props.layout.json_data?.link_to_attribute ?? false,
        linkAttribute:props.layout.json_data?.linkAttribute ?? null,
        linkAttributeFancyBox:props.layout.json_data.linkAttributeFancyBox ?? false
    },
});

const update = () => {
    form.put(route('card-layouts.update',props.layout),{
        onSuccess: () => {
